...
with open(f'tmp_{process_id}/msa.prm', 'w') as prm_file:
    ...
    print(f"'tmp_{process_id}/slice'    (slice file name string [SFN], slice files will be searched with names [SFN]+\"_###.sli\" where ### is a three digit number identifying the indiviual slices in numbered order from entrance slice 001 to exit slice [NOSD]. )", file=prm_file)
